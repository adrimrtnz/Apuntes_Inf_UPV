...
# python experiment.py OCR_14x14 "0.1 1 10 100 1000 10000" "0.1 1 10 100 10000"
if len(sys.argv) != 4:
...
for a in alphas:
    for b in bs:
        ...
        print(f' {a:7.1f} {b:7.1f} {E:4d} {k:3d} {int(nerr):3d} {perr*100:7.1f}  [{(perr-r)*100:3.1f}, {(perr+r)*100:3.1f}]')
...
print('           Task       a       b Ete (%)      Ite (%)')
print('--------------- ------- ------- ------- ------------')
print(f'{sys.argv[1]:>15s} {best_alpha:7.1f} {best_beta:7.1f} {min_perr*100:7.1f}  [{(min_perr-best_r)*100:3.1f}, {(min_perr+best_r)*100:3.1f}]')