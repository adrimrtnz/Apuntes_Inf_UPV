//'use strict' // causa error porque global3 no está declarada (let o var).
...
function f1 (arg) {
	global1_let = arg;    // Puedo también modificar las otras globales? Sí
...
function f2 () {
	...
	// console.log ("fin --> let_i=" + let_i) // Esto NO FUNCIONARÍA

	local_let = var_i - 5; // Me equivoco al teclear "local1_let"
