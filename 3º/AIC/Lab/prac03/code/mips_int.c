...
#define lee_Rfuente1 hay_fuente1
#define lee_Rfuente2 hay_fuente2
#define escribe_Rdestino hay_destino
#define consumidor_en_fuente1 hay_fuente1
#define consumidor_en_fuente2 hay_fuente2
#define productor hay_destino
