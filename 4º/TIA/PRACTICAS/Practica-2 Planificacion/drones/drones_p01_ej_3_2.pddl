...
(:init
    ...
    (taller A) ; MODIFICAION 2
    (taller B) ; MODIFICAION 2
    (taller C) ; MODIFICAION 2
    (taller F) ; MODIFICAION 2
    (taller G) ; MODIFICAION 2

    (taller-libre A) ; MODIFICAION 2
    (taller-libre B) ; MODIFICAION 2
    (taller-libre C) ; MODIFICAION 2
    (taller-libre F) ; MODIFICAION 2
    (taller-libre G) ; MODIFICAION 2
    ...
    ;; USOS DISPONIBLES BRAZOS ROBOTICOS
    (= (usos-brazo A) 2)
    (= (usos-brazo B) 2)
    (= (usos-brazo C) 2)
    (= (usos-brazo D) 1)
...
(:metric minimize (+ (coste-mantenimiento) (+ (*0.5 (total-time)) (*0.7 (coste-recargas))))))  ; MODIFICACION 2